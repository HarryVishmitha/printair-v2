            ...
            <div class="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div class="space-y-2 max-w-xl">
                    ...
                    <h2 class="text-xl sm:text-2xl font-bold leading-tight">
                        Add a new user to Printair
                    </h2>
                    <p class="text-xs sm:text-sm text-white/80">
                        System will generate a secure password and email the credentials automatically.
                    </p>
                </div>
            </div>
        </section>
                    ...
                    <div>
                        ...
                        <select id="working_group_id" name="working_group_id"
                            ...
                            @foreach ($workingGroups as $wg)
                                <option value="{{ $wg->id }}" @selected(old('working_group_id', $publicGroupId) == $wg->id)>
                                    {{ $wg->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="space-y-2">
                        ...
                        <label
                            ...
                            <input type="checkbox" name="email_notifications" value="1"
                                ...
                                @checked(old('email_notifications', true))>
                    ...
                    <div class="space-y-2">
                        ...
                        <label
                            ...
                            <input type="checkbox" name="system_notifications" value="1"
                                class="rounded border-slate-300 text-slate-900 focus:ring-slate-900/20"
                                @checked(old('system_notifications', true))>
