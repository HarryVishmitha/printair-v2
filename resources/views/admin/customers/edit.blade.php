...
<x-app-layout>
    ...
    <x-slot name="breadcrumbs">
        <a href="{{ route('admin.customers.index') }}" class="text-slate-500 hover:text-slate-700">Customers</a>
    ...
    <div class="space-y-6">
        ...
        <section
            ...
            <div
                class="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-500 to-indigo-500 text-white shadow-md shadow-sky-500/30">
            ...
            <div class="space-y-1">
                <h2 class="text-lg font-semibold text-slate-900">
                    Edit Customer – {{ $customer->full_name ?? $customer->name }}
                </h2>
                <p class="text-xs sm:text-sm text-slate-500 max-w-2xl">
                    Update contact, working group or internal notes for this customer. Changes apply for all future jobs.
                </p>
            </div>
        </section>
