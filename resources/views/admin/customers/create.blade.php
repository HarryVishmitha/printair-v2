...
<x-app-layout>
    ...
    <x-slot name="pageTitle">New Customer</x-slot>
        ...
        <section
            ...
            <div class="space-y-1">
                ...
                <p class="text-xs sm:text-sm text-slate-500 max-w-2xl">
                    Store key details for walk-in and repeat customers so you can reuse them across quotations, orders and invoices.
                </p>
            </div>
        </section>
