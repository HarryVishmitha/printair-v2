...
<body class="antialiased bg-gray-50 text-gray-900 font-sans" x-data="{
    ...
    <!-- Home Layout -->
    <!-- Top bar -->
    <header class="sticky top-0 z-40 w-full border-b border-slate-200 bg-slate-50 text-slate-700 shadow-sm">
        <div
        ...
        <div
            class="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-sm supports-[backdrop-filter]:bg-white/90">
